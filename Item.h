...
enum ItemType { SHIP, BINOCULARS, TOOLS, FOOD, OBSTACLES, CLUE, TREASURE };

enum ObstacleType { BOULDER, TREE, MONSTER };

enum FoodType { SNACK, MEAL, FEAST };
