...
Player::Player()
    : toolCount(0), binoculars(false), ship(false), clueY(0), clueX(0),
      clue(false), seeClue(false), energy(100), money(1000), y(0), x(0) {
...
bool Player::hasBinoculars() { return binoculars; }

void Player::setBinoculars(bool value) { binoculars = value; }

bool Player::hasShip() { return ship; }

void Player::setShip(bool value) { ship = value; }
...
bool Player::wantSeeClue() { return seeClue; }

void Player::setSeeClue(bool value) { seeClue = value; }
...
Tool **Player::getTools() { return tools; }
...
bool Player::isAlive() { return (energy > 0); }
...
int Player::getNumberOfTool() { return toolCount; }
