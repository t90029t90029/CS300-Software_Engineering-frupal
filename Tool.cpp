...
Tool::Tool() {
  ...
  string names[itemCount][nameCount] = {// Boulder
                                        {"Hammer", "Pickaxe", "Chisel"},
                                        // Tree
                                        {"Hatchet", "Axe", "Saw"},
                                        // Monster
                                        {"Spear", "Sword", "Bow"}};
  ...
  string adjectives[ratingCount] = {"Wooden", "Rusty", "Tempered", "Magic"};
...
int Tool::getStrength() { return rating; }

ObstacleType Tool::getObstacle() { return obstacleType; }
...
int Tool::getMoney() { return 0; }

int Tool::getTruth() { return 0; }

void Tool::setClue(string clue, int y, int x) { return; }
